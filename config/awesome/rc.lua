...
modkey = "Mod4"
altkey = "Mod1" -- this is the alt key
...
DEFAULT_LAYOUT_IDX = 2 -- tile; indexes start from 1 in lua
-- }}}
...
awful.screen.connect_for_each_screen(function(s)
    ...
    awful.tag({ "1", "2", "3", "4", "5", "6", "7", "8", "9" }, s, awful.layout.layouts[DEFAULT_LAYOUT_IDX])
    ...
    s.mywibox:setup {
        ...
        { -- Right widgets
        	...
        	awful.widget.watch('bash -c "~/.config/polybar/scripts/get_cpu.py"', 1),
        	wibox.widget.textbox(' | '),
...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey,           }, "KP_Enter", function () awful.spawn(terminal) end,
              {description = "open a terminal", group = "launcher"}),
	awful.key({ modkey, "Control", altkey }, "r", awesome.restart,
